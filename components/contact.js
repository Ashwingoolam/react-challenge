        ...
        <Grid className="contact-grid">
          <Cell col={6}>
            ...
            <p style={{ width: "75%", margin: "auto", paddingTop: "1em" }}>
              {" "}
              hello their i am Aspiring full stact developer currently learning
              react but i love MERN Stack and i love computers and technology
            </p>
          </Cell>
          <Cell col={6}>
            <h2>Contact Me</h2>
